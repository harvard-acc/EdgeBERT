...
solution file add [file join $sfd DecMemCore.h] -type CHEADER
...
setup_libs
setup_clock 2.0
setup_hier {DecMemCore}
go compile
go libraries
go assembly
for {set k 0} {$k < 16} {incr k} {
    directive set /DecMemCore/DecInputMemRun/input_mem_inst.banks.bank.array_impl.data$k:rsc -MAP_TO_MODULE {BLOCK_1R1W_RBW}
}
directive set /DecMemCore/DecMaskMemRun/mask_mem_inst.banks.bank.array_impl.data0:rsc -MAP_TO_MODULE {BLOCK_1R1W_RBW}
go architect
go allocate
go schedule
go dpfsm
